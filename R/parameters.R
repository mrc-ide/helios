...
#' * `setting_specific_riskiness_workplace_meanlog`: The mean of the truncated log-normal distribution from which the setting-specific riskiness of individual workplaces is drawn
#' * `setting_specific_riskiness_workplace_sdlog`: The standard deviation of the truncated log-normal distribution from which the setting-specific riskiness of individual workplaces is drawn
#' * `setting_specific_riskiness_workplace_min`: The minimum value for truncation on the left tail of the truncated log-normal distribution from which the setting-specific riskiness of individual workplaces is drawn
#' * `setting_specific_riskiness_workplace_max`: The maximum value for truncation on the right tail of the truncated log-normal distribution from which the setting-specific riskiness of individual workplaces is drawn
...
#' * `setting_specific_riskiness_school_meanlog`: The mean of the truncated log-normal distribution from which the setting-specific riskiness of individual schools is drawn
#' * `setting_specific_riskiness_school_sdlog`: The standard deviation of the truncated log-normal distribution from which the setting-specific riskiness of individual schools is drawn
#' * `setting_specific_riskiness_school_min`: The minimum value for truncation on the left tail of the truncated log-normal distribution from which the setting-specific riskiness of individual schools is drawn
#' * `setting_specific_riskiness_school_max`: The maximum value for truncation on the right tail of the truncated log-normal distribution from which the setting-specific riskiness of individual schools is drawn
...
#' * `setting_specific_riskiness_leisure_meanlog`: The mean of the truncated log-normal distribution from which the setting-specific riskiness of individual leisure locations is drawn
#' * `setting_specific_riskiness_leisure_sdlog`: The standard deviation of the truncated log-normal distribution from which the setting-specific riskiness of individual leisure settings is drawn
#' * `setting_specific_riskiness_leisure_min`: The minimum value for truncation on the left tail of the truncated log-normal distribution from which the setting-specific riskiness of individual leisure settings is drawn
#' * `setting_specific_riskiness_leisure_max`:The maximum value for truncation on the right tail of the truncated log-normal distribution from which the setting-specific riskiness of individual leisure settings is drawn
...
#' * `setting_specific_riskiness_household_meanlog`: The mean of the truncated log-normal distribution from which the setting-specific riskiness of individual households is drawn
#' * `setting_specific_riskiness_household_sdlog`: The standard deviation of the truncated log-normal distribution from which the setting-specific riskiness of individual households is drawn
#' * `setting_specific_riskiness_household_min`: The minimum value for truncation on the left tail of the truncated log-normal distribution from which the setting-specific riskiness of individual households is drawn
#' * `setting_specific_riskiness_household_max`: The maximum value for truncation on the right tail of the truncated log-normal distribution from which the setting-specific riskiness of individual households is drawn
