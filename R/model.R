...
#' @param population_data A named list representing the seeded population, as generated by [generate_population_data()]
#'
#' @family model
#' @export
