...
(ref:age) Example age groups for 5000 individuals.
...
1. **Households**
The sizes (Figure \@ref(fig:household-size)) and age compositions of households are based on the 2011 Office for National Statistics survey in the United Kingdom (UK), following @hinch2021openabm.
...
data.frame(school_sizes) |>
  ggplot(aes(y = school_sizes, x = 1)) +
  geom_point() +
  labs(x = "", y = "Number of students per school") +
