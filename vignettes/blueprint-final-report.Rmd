...
Relative to a non-intervention baseline, installing far UVC at a coverage of 10% and assuming 60% efficacy, far UVC reduced the total population becoming infected by 5.5% (range 5.3%-6.7%) for the "Influenza-Like" archetype under random coverage and by 8.1% (range 6.0%-10.1%) under targeted coverage. Increasing the efficacy to 80% resulted in additional reductions of 7.1% (range 6.1%-9.8%) and 12.6% (range 10.8%-12.7%) to of baseline for random and targeted coverage respectively. For the "SARS-CoV-2-like" pathogen, installing far UVC at 10% coverage with 60% efficacy reduced the epidemic final size, relative to the no-far UVC baseline, by 1.2% (0.8-1.1%) for random coverage and 1.5% (1.1-1.8%) for targeted coverage. The reduction in final epidemic size increased to 2.1% (1.6-2.2%) for random coverage and 2.7% (2.3-2.4%) for targeted coverage when the efficacy was increased to 80%.
