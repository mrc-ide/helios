...
#### Epidemic Peak Size
Figure \@ref(fig:epidemic-peak-size) shows the impact of far UVC deployment on the peak size of the simulated epidemic. Assuming 10% coverage and 60% efficacy, random far UVC installation led to a 11.6% (range 13.7%-18.0%) reduction in the epidemic peak size the "Influenza-Like" archetype, and 4.5% (range 1.9%-5.6%) for the "SARS-CoV-2-Like" archetype. At 10% coverage and 80% assumed efficacy, these are 14.0% (range 13.3%-24.3%) and 6.8% (range 4.5%-7.5%) respectively. For the "influenza-like" pathogen, targeting 60% efficacious far UVC at the riskiest 10% of locations produced a 21.8% (range 19.4-25.8%) reduction in epidemic peak size, which increased to 29.3% (range 28.7-29.5%) when efficacy was set to 80%. For the "SARS-CoV-2-like" pathogen, a 10% targeted far UVC strategy resulted in a 7.7% (range 6.3-8.6%) and 11.1% (range 8.6-10.3%) reduction in epidemic peak size respectively, relative to the no-intervention baseline.
