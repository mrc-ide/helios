...
Here, we provide a (very) brief summary of the way in which we generated the results presented here. For both endemic and epidemic pathogen archetypes, we run the `helios` model with a range of parameter combinations varying far UVC coverage, far UVC efficacy, how the far UVC is deployed (at random or targeted at the riskiest % of locations), and for two pathogen archetypes:
