...
In terms of "peak size", assuming 10% coverage and 60% efficacy, far UVC installation led to a A% (range B%-C%) reduction in annual infection incidence for "Influenza-Like" and X% (range Y%-Z%) for "SARS-CoV-2-Like". At 10% coverage and 80% assumed efficacy, these are A% (range B%-C%) and X% (range Y%-Z%) respectively. Increasing far UVC coverage led to progressively higher impact (i.e. greater reduction in peak size), with a larger (proportional) impact on disease burden for an "Influenza-Like" pathogen than a "SARS-CoV-2-Like" pathogen. Under some scenarios (e.g. X% coverage and Y% efficacy), far UVC installation was sufficient to prevent the epidemic occurring entirely, though an important limitation here is that we do not explicitly model imported infections from other locations (which typically sustain an epidemic).

In terms of "peak timing", assuming 10% coverage and 60% efficacy, far UVC installation led to the peak occurring A days (range B-C days) later for "Influenza-Like" and X days (range Y days-Z days) for "SARS-CoV-2-Like". At 10% coverage and 80% assumed efficacy, these are A days (range B - C days) and X days (range Y days - Z days) respectively.In terms of "epidemic final size", assuming 10% coverage and 60% efficacy, far UVC installation led to a total of A% (range B%-C%) of the population becoming infected for the "Influenza-Like" pathogen, and X% (range Y%-Z%) for the "SARS-CoV-2-Like" pathogen. At 10% coverage and 80% assumed efficacy, these are A% (range B%-C%) and X% (range Y%-Z%) respectively.
