...
To assess the potential of far UVC deployment to curtail the transmission of a theoretical pathogen fixed the model's pathogen and far UVC parameters and compared the  

We assumed that the transmission intensity experienced by individuals in their household, workplace or school, and leisure setting was three times greater than that experienced in their community setting, and tuned the relative, setting-specific transmissibility parameters ($\beta_{m}$) to approximate a basic pathogen reproductive number ($R0$) of 2.
...
Explanation of epidemic exemplar.
...
The `helios` framework can also be used to assess the sensitivity of the individual-based model to pathogen (e.g. duration of immunity), human population (e.g. setting-specific transmission intensity), and operational (e.g. far UVC) parameters on measures of interest. To illustrate, we simulated an epidemic with varying levels of transmission intensity ($R0$) and assessed the sensitivity of final epidemic size, defined as the total proportion of the population that gets infected during the course of an epidemic, to far UVC coverage, efficacy, and deployment strategy. Figures \@ref(fig:sweep-R0-coverage):\@ref(fig:sweep-efficacy-coverage) depict how the final epidemic size changes with $R0$, far UVC coverage, far UVC efficacy, and far UVC deployment strategy, and illustrate how `helios` model outputs can be graphed.  

The deployment of far UVC could reduce the total percentage/proportion of the population that is infected during an outbreak of pathogen to which full and lasting immunity is acquired (Figures \@ref(fig:sweep-R0-coverage):\@ref(fig:sweep-efficacy-coverage)). For a given transmission intensity ($R0$), increasing the coverage (Figure \@ref(fig:sweep-R0-coverage)) and/or efficacy (Figure \@ref(fig:sweep-R0-efficacy), Figure \@ref(fig:sweep-efficacy-coverage)) of far UVC reduced the final size of an epidemic outbreak of a theoretical pathogen, defined as the total proportion of the population that the pathogen infects during the outbreak

(ref:sweep-R0-coverage) The effect of R0 and far UVC coverage, under random and targeted far UVC deployment, on the proportion of the population that a pathogen infects when full and lasting immunity is acquired by infected individuals.
...
(ref:sweep-R0-efficacy) The effect of R0 and far UVC efficacy, under random and targeted far UVC deployment, on the proportion of the population that a pathogen infects when full and lasting immunity is conferred on infected individuals.
...
(ref:sweep-efficacy-coverage) The effect of far UVC efficacy and coverage, under random and targeted far UVC deployment, on the proportion of the population that a pathogen infects when full and lasting immunity is conferred on infected individuals.
