...
Using the modelling framework described above, we carried out a suite of exploratory analyses evaluating the potential impact of far UVC deployment on the burden of a hypothetical endemic respiratory virus (i.e. a virus for which disease burden

We considered two pathogen archetypes:

-   **"SARS-CoV-2-Like" Archetype** - $R_0$ of 2.5, a mean latent period of 2 days and a mean duration of infectiousness of 4 days.

-   **"Influenza-Like" Archetype** - $R_0$ of 1.5, a mean latent period of 1 day and a mean duration of infectiousness of 2 days.

For each pathogen archetype, we investigated the effect of far UVC efficacy and far UVC coverage on another outcome, running multiple model simulations varying:

-   **far UVC Coverage:** Coverages of either 10%, 25% or 50% - in all cases, far UVC was assumed to be installed in schools, workplaces and leisure locations only (i.e. not households), and within each Setting Type, a random set of locations .

-   **far UVC Efficacy:** Efficacies of 40%, 60% and 80% were explored, with the assumption that far UVC efficacy was identical across all Settings and Locations where it had been installed.

All results presented here are
...
Figure \@ref(fig:school-size): The impact of varying far UVC coverage and efficacy on the annual incidence of a respiratory virus, for each of the pathogen archetypes considered.
