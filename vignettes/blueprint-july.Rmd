...
<!-- Note: what data is the leisure Setting Type based on? -->
In this update to the model, we parameterise the household and school Setting Types using data from the USA as follows.
