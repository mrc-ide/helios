...
In particular, we used data from the UK to parameterise the household and school Setting Types and data from the USA to parameterise the workplace Setting Type.
In this update to the model, we parameterise the household and school Setting Types using data only from the USA.
