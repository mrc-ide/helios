...
We used the above equations in tandem with estimates of variation in the ventilation rates in different spaces and parameter estimates for SARS-CoV-2 from Blatchley et al (see Table 1) to explore how Location riskiness varied whilst varying:

1.  Infection Prevalence (i.e. the number of infectious individuals in the space).
2.  Air Changes Per Hour (considering the minimum and maximum of the ranges provided in Table 1)
...
At higher values of $R_{0}$ however, infection prevalence saturates and the rate at which increasing values of $R_0$ increases prevalence diminishes.
