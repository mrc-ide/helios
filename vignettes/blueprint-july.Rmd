...
Previously, we had used a mixture of data from the United Kingdom (UK) and the USA.
...
In this update to the model, we alter the household and school Setting Types to be parameterised using data from the USA as follows.
