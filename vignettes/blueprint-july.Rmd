...
<!-- Note: what data is the leisure Setting Type based on? --> In this update to the model, we parameterise the household and school Setting Types using data from the USA as follows.

### Household Setting Type

To parameterise the model's household distribution (and implicitly age distribution) we use data from an synthetic household population of the USA developed by RTI International [@wheaton2014us].
...
As school sizes were provided in ranges (e.g. "500 to 599") we used the midpoint (e.g. 550).
